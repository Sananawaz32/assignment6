...
const Team  = () => {
    return (
        <div className='w-full flex flex-col items-center justify-center my-10 bg-[#F7F7F7]'>
            <h1 className='font-roboto text-[48px] font-bold leading-[57.6px] text-center mb-4'>Our Team</h1>
            ...
            <div className='mt-8 flex justify-center sm:block lg:hidden'>
                <button className='text-black bg-white p-2 px-6 rounded-md text-sm border border-black'>View All</button>
            </div>
        </div>
    );
};
