            ...
            <div className='max-w-7xl pt-3 px-4 space-y-8 md:px-8'>
                <div className='flex flex-col md:flex-row items-center justify-between'>
                    <div className='mb:4 md:mb-0'>
                        <h1 className='font-bold text-xl text-center sm:text-left text-black'>Subscribe to our newsletter</h1>
                        <p className='text-center sm:text-left text-black'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                    </div>
                    <div className='flex flex-col w-full md:w-auto'>
                        <div className='flex flex-col sm:flex-col md:flex-row items-center space-y-3 sm:space-y-3 w-full md:space-y-0 md:space-x-3'>
                            <input type="email" placeholder='Enter your email' className='p-2 px-7 rounded-md border border-black tracking-widest text-left text-gray-800 w-full sm:w-auto' />
                            <button className='border border-black hover:text-primary hover:bg-text p-1 px-4 rounded-md text-lg'>Subscribe</button>
                        </div>
                        <p className='text-[13px] mt-3 text-center md:text-left text-black'>By subscribing you agree to our{" "}
                ...
                <div className='border-t py-12 border-black pt-4 flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0'>
                    <div className='flex flex-col md:flex-row gap-5 text-center md:text-left text-black'>
                        <p>2023 Ddsgnr. All rights reserved. (PS)</p>
                        <div className='flex space-x-4'>
                            <Link href='#' className='text-black underline underline-offset-3'>Privacy Policy</Link>
                            <Link href='#' className='text-black underline underline-offset-3'>Terms of Services</Link>
                            <Link href='#' className='text-black underline underline-offset-3'>Cookies Settings</Link>
                        </div>
                    </div>
